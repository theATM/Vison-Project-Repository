...
def printTrainParams():
    ...
    print(f"Trainset Batch size = {par.DATA_DATASET_BATCH_SIZE}")
    print(f"Trainset workers = {par.DATA_DATASET_NUM_WORKERS}")
    print(f"Grad per batch = {par.TRAIN_GRAD_PER_BATCH}")
    print(f"Print per batch = {par.TRAIN_PRINT_PER_BATCH}")
